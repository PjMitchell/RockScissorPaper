...
{
    public class RoshamboHubNotificationService
    {
        ...
        public RoshamboHubNotificationService(GameEventManager eventManager, IStatisticsService statsService, IGameService gameService)
        {
