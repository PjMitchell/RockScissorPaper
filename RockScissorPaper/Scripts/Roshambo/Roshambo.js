...
(function (Roshambo) {
    ...
    //    Selection: number
    //    }
    var _gameId, _playerId, api = new Core.Api();
    ...
    function processSelection(input) {
        var inputModel = { PlayerId: _playerId, GameId: _gameId, Selection: input }, $buttonbox = $('#playerOptions');

        api.put('Games', _gameId, inputModel).done(function (data) {
            processResult(data);
        });
